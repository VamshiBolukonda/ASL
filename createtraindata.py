...
while True:
    ...
    cv2.putText(frame, "0 : "+str(count['0']), (10, 90), cv2.FONT_HERSHEY_PLAIN, 1, (0,255,255), 1)
    ...
    if interrupt & 0xFF == ord('0'):
        print('0 saved as', count['0'], '.jpg')
        cv2.imwrite(directory+'0//'+str(count['0'])+'.jpg', test_image)
        count['a'] += 1
